...
#################Simulations.  We let p2 be 0.01, 0.5, 0.1, 0.25, 0.5.


sim_study(nsims=1000, population=population1, p1_symp=0.3, p1_nonsymp=0.1, p2=0.01)  ##Letting p2 vary.
...
sim_study(nsims=1000, population=population2, p1_symp=0.3, p1_nonsymp=0.1, p2=0.01)  ##Letting p2 vary.
...
sim_study(nsims=1000, population=population3, p1_symp=0.3, p1_nonsymp=0.1, p2=0.01)  ##Letting p2 vary.
...
sim_study(nsims=1000, population=population4, p1_symp=0.3, p1_nonsymp=0.1, p2=0.01)  ##Letting p2 vary.
...
sim_study(nsims=1000, population=population5, p1_symp=0.3, p1_nonsymp=0.1, p2=0.01)  ##Letting p2 vary.
...
sim_study(nsims=1000, population=population6, p1_symp=0.3, p1_nonsymp=0.1, p2=0.01)  ##Letting p2 vary.
